...
function makeStartDateTimeISOString(form) {
    ...
    return form['startdate-event'] + 'T' + form['starttime-event'] + makeTimezoneOffsetISOString(form.timezoneOffset);

}

function makeEndDateTimeISOString(form) {
    
    return form['enddate-event'] + 'T' + form['endtime-event'] + makeTimezoneOffsetISOString(form.timezoneOffset);
